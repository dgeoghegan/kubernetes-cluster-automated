...
Note:
Interactions with the system are operated through management/manage.sh, which serves as the single entrypoint for environment selection and lifecycle actions. All actions are then executed by Terraform or by a containerized runner for Ansible or kubectl. 
